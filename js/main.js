jQuery(document).ready(function() {
	...
	$.fn.loadquickActions = function(){ 
		$.getJSON("data/config.json", function(data){
			...
			$("nav .action-list1:first-child li:first-child a" ).attr("href",quickActions[0].actions[0].url);
			$("nav .action-list1:first-child li:first-child a" ).html(quickActions[0].actions[0].label);
			$("nav .action-list1:first-child li:nth-child(2) a" ).attr("href",quickActions[0].actions[1].url);
			$("nav .action-list1:first-child li:nth-child(2) a" ).html(quickActions[0].actions[1].label);
			$("nav .action-list1:first-child li:last-child a" ).attr("href",quickActions[0].actions[2].url);
			$("nav .action-list1:first-child li:last-child a" ).html(quickActions[0].actions[2].label);

			$("nav .action-list2:nth-child(2) li:first-child a" ).attr("href",quickActions[1].actions[0].url);
			$("nav .action-list2:nth-child(2) li:nth-child(2) a" ).attr("href",quickActions[1].actions[1].url);
			$("nav .action-list2:nth-child(2) li:last-child a" ).attr("href",quickActions[1].actions[2].url);
			$("nav .action-list2:nth-child(2) li:first-child a" ).html(quickActions[1].actions[0].label);
			$("nav .action-list2:nth-child(2) li:nth-child(2) a" ).html(quickActions[1].actions[1].label);
			$("nav .action-list2:nth-child(2) li:last-child a" ).html(quickActions[1].actions[2].label);

			$("nav .action-list3:last-child li:first-child a").attr("href",quickActions[2].actions[0].url);
			$("nav .action-list3:last-child li:nth-child(2) a").attr("href",quickActions[2].actions[1].url);
			$("nav .action-list3:last-child li:last-child a").attr("href",quickActions[2].actions[2].url);
			$("nav .action-list3:last-child li:first-child a").html(quickActions[2].actions[0].label);
			$("nav .action-list3:last-child li:nth-child(2) a").html(quickActions[2].actions[1].label);
			$("nav .action-list3:last-child li:last-child a").html(quickActions[2].actions[2].label);
